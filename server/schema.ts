...
export const generatePasswordResetToken = pgTable(
...
export const favouriteProduct = pgTable(
  'favourite_products',
  {
    id: text('id')
      .primaryKey()
...
export const favouritesRelations = relations(
  favouriteProduct,
  ({ many, one }) => ({
    products: one(products, {
...
export const productVariantConditionRelations = relations(
...
export const productVariantColorRelations = relations(
  productVariantColor,
  ({ one }) => ({
    productVariant: one(productVariant, {
...
export const locations = pgTable('locations', {
  ...
  googleMapsEmbed: text('googleMapsEmbed').notNull(),
  createdAt: timestamp('createdAt', { mode: 'date' }).defaultNow(),
});
